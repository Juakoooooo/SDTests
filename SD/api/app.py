...
def get_redis_node_by_range(key):
    """Devuelve el nodo Redis correspondiente basado en rangos de la clave"""
    ...
    if 'a' <= first_char <= 'd':
        ...
        node_name = 'redis8'
    logging.debug(f"Clave {key} asignada a {node_name} usando rangos")
    return redis_nodes[node_name], node_name
