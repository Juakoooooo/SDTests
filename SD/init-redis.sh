...
#echo "Redis está listo. Aplicando configuraciones..."
#
#redis-cli -h redis2 -p 6379 CONFIG SET maxmemory 1mb
...
#echo "Redis está listo. Aplicando configuraciones..."
#
#redis-cli -h redis3 -p 6379 CONFIG SET maxmemory 1mb
...
#echo "Redis está listo. Aplicando configuraciones..."
#
#redis-cli -h redis4 -p 6379 CONFIG SET maxmemory 1mb
...
#echo "Redis está listo. Aplicando configuraciones..."
#
#redis-cli -h redis5 -p 6379 CONFIG SET maxmemory 1mb
...
#echo "Redis está listo. Aplicando configuraciones..."
#
#redis-cli -h redis6 -p 6379 CONFIG SET maxmemory 1mb
...
#echo "Redis está listo. Aplicando configuraciones..."
#
#redis-cli -h redis7 -p 6379 CONFIG SET maxmemory 1mb
...
#echo "Redis está listo. Aplicando configuraciones..."
#
#redis-cli -h redis8 -p 6379 CONFIG SET maxmemory 1mb
